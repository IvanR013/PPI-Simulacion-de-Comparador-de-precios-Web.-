 ...
 * 
 * resultadosDiv controla el comportamiento del div del HTML que será donde despues la funcion genere los elementos de muestra con los productos y sus referencias.
 * 
 * El funcionamiento a groso modo, es iterar el array de búsquedas y validar sus atributos como el precio, envío y ofertas. 
...
document.getElementById('buscar').addEventListener('keydown', (event) => {
    if (event.key === "Enter") simularBusqueda()
});


// Al hacer click en el botón de búsqueda, se ejecuta la función simularBusqueda
